...
$().ready(function () {
  ...
  readCookie();
  createOptions("tutorial", ["Sélectionnez un exemple de MCD", "Entité", "Attribut d'entité", "Association", "Attribut d'association", "Cardinalités", "Association de dépendance fonctionnelle", "Explication interactive des cardinalités", "Association réflexive", "Flèche sur une patte", "Schéma sur plusieurs rangées", "Réarrangement automatique", "Réarrangement automatique minimal", "Explication des cardinalités", "Rôle d'une patte pour le MLD", "MLD sous forme de diagramme relationnel", "Dévoilement progressif du schéma", "Entité faible (ou identification relative)", "Identifiant composite", "Entité sans identifiant", "MCD vide", "Boîtes homonymes", "Vue en extension", "Agrégation (ou pseudo-entité)", "Contrainte d'intégrité fonctionnelle (CIF)", "Contrainte sur associations", "Explication interactive d'une contrainte", "Héritage (ou spécialisation)"])
});
