...
\begin{itemize}
  ...
  \item \relat{Étudiant} (\prim{num étudiant}, \attr{nom}, \foreign{num. stage}, \attr{date signature}, \attr{date}, \attr{note stage})
  \begin{itemize}
    ...
    \item Le champ \emph{num. stage} est une clé étrangère. Il a migré par l'association de dépendance fonctionnelle \emph{Attribuer} à partir de l'entité \emph{Stage} en perdant son caractère identifiant.
    \item Le champ \emph{date signature} a migré à partir de l'association de dépendance fonctionnelle \emph{Attribuer}.
    \item Le champ \emph{date} a migré par l'association de dépendance fonctionnelle \emph{Soutenir} à partir de l'entité \emph{Date} en perdant son caractère identifiant. De plus, comme la table créée à partir de cette entité a été supprimée, il n'est pas considéré comme clé étrangère.
