...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item Le champ \emph{magna} est une clé étrangère. Il a migré par l'association de dépendance fonctionnelle \emph{VITAE} à partir de l'entité \emph{TRISTIS} en perdant son caractère identifiant.
  \end{itemize}
  ...
  \begin{itemize}
    ...
    \item Le champ \emph{gravida} est une clé étrangère. Il a migré à partir de l'entité-fille \emph{NEC} (supprimée) dans laquelle il avait déjà migré à partir de l'entité \emph{CURABITUR}.
