...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item Le champ \emph{Réf. client} est une clé étrangère. Il a migré par l'association de dépendance fonctionnelle \emph{DF0} à partir de l'entité \emph{CLIENT} en perdant son caractère identifiant.
  \end{itemize}
