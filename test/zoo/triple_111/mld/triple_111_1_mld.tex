...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item Le champ \emph{technicien} est simple attribut. C'est une clé étrangère qui a migré directement à partir de l'entité \emph{Technicien} en perdant son caractère identifiant. Il fait en outre partie de clés alternatives matérialisées par les contraintes d'unicité 1 et 2.
  \end{itemize}
