...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item Le champ \emph{responsable} a migré par l'association de dépendance fonctionnelle \emph{Gérer} à partir de l'entité \emph{Responsable} en perdant son caractère identifiant. De plus, comme la table créée à partir de cette entité a été supprimée, il n'est pas considéré comme clé étrangère.
  \end{itemize}
