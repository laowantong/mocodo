...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item Le champ \emph{site} est une clé étrangère. Il a migré directement à partir de l'entité \emph{Site} en perdant son caractère identifiant. Il fait en outre partie d'une clé alternative matérialisée par la contrainte d'unicité 1.
  \end{itemize}
