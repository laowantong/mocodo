...
def safePrint(s):
	try:
		print s
	except UnicodeEncodeError: # seems that when called from PHP, Python is unable to guess correctly the encoding of the standard output
		print s.encode("utf8")
...
class Common:
	...
	def dumpMldFiles(self, mcd):
		...
		try:
			...
			safePrint(_("Problem during MLD generation!"))
